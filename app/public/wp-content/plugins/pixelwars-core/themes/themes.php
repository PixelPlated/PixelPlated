<?php
	...
	switch ($pixelwars_core_template)
	{
		case 'consultify':
			...
			include_once($pixelwars_core_ABSPATH . 'themes/global/meta-box-post-header-style.php');
		...
		case 'foodsy':
			...
			include_once($pixelwars_core_ABSPATH . 'themes/foodsy/widget-main-slider.php');
			include_once($pixelwars_core_ABSPATH . 'themes/global/posts-columns.php');
			include_once($pixelwars_core_ABSPATH . 'themes/global/enqueue-styles-scripts.php');
			include_once($pixelwars_core_ABSPATH . 'themes/global/image-sizes.php');
			include_once($pixelwars_core_ABSPATH . 'themes/global/fonts.php');
			...
			include_once($pixelwars_core_ABSPATH . 'themes/global/meta-box-post-header-style.php');
			include_once($pixelwars_core_ABSPATH . 'themes/global/meta-box-title-visibility.php');
			include_once($pixelwars_core_ABSPATH . 'themes/global/meta-box-featured-area.php');
			include_once($pixelwars_core_ABSPATH . 'themes/global/meta-box-featured-media.php');
			include_once($pixelwars_core_ABSPATH . 'themes/global/meta-box-gallery-type.php');
			include_once($pixelwars_core_ABSPATH . 'themes/global/meta-box-sidebar.php');
			include_once($pixelwars_core_ABSPATH . 'themes/global/share-links.php');
			include_once($pixelwars_core_ABSPATH . 'themes/global/related-posts.php');
			include_once($pixelwars_core_ABSPATH . 'themes/global/widget-social-media-icon.php');
			include_once($pixelwars_core_ABSPATH . 'themes/global/widget-about-me.php');
		...
		case 'episody':
			...
			include_once($pixelwars_core_ABSPATH . 'themes/episody/widget-main-slider.php');
			include_once($pixelwars_core_ABSPATH . 'themes/global/posts-columns.php');
			include_once($pixelwars_core_ABSPATH . 'themes/global/enqueue-styles-scripts.php');
			include_once($pixelwars_core_ABSPATH . 'themes/global/image-sizes.php');
			include_once($pixelwars_core_ABSPATH . 'themes/global/fonts.php');
		...
		case 'theblogger':
			...
			include_once($pixelwars_core_ABSPATH . 'themes/global/posts-columns.php');
			include_once($pixelwars_core_ABSPATH . 'themes/global/post-type-portfolio-2.php');
			include_once($pixelwars_core_ABSPATH . 'themes/global/enqueue-styles-scripts.php');
			include_once($pixelwars_core_ABSPATH . 'themes/global/image-sizes.php');
			include_once($pixelwars_core_ABSPATH . 'themes/global/fonts.php');
			include_once($pixelwars_core_ABSPATH . 'themes/global/meta-box-post-header-style.php');
		...
		case 'ikonik':
			...
			include_once($pixelwars_core_ABSPATH . 'themes/global-vcard/meta-box-featured-media.php');
			include_once($pixelwars_core_ABSPATH . 'themes/global-vcard/meta-box-portfolio-details.php');
			include_once($pixelwars_core_ABSPATH . 'themes/global-vcard/widget-contact-form.php');
			include_once($pixelwars_core_ABSPATH . 'themes/global-vcard/widget-social-media-icon.php');
			include_once($pixelwars_core_ABSPATH . 'themes/global-vcard/widget-section-title.php');
			include_once($pixelwars_core_ABSPATH . 'themes/global-vcard/widget-fun-fact.php');
			include_once($pixelwars_core_ABSPATH . 'themes/global-vcard/widget-client.php');
			include_once($pixelwars_core_ABSPATH . 'themes/global-vcard/widget-process.php');
			include_once($pixelwars_core_ABSPATH . 'themes/global-vcard/widget-progress-bar.php');
			include_once($pixelwars_core_ABSPATH . 'themes/global-vcard/widget-service.php');
			...
			include_once($pixelwars_core_ABSPATH . 'themes/global-vcard/widget-button.php');
			include_once($pixelwars_core_ABSPATH . 'themes/global/image_max_dimensions.php');
			break;
		...
		case 'ucard':
			...
			include_once($pixelwars_core_ABSPATH . 'themes/ucard/post-type-portfolio.php');
			include_once($pixelwars_core_ABSPATH . 'themes/ucard/meta-box-portfolio-details.php');
			include_once($pixelwars_core_ABSPATH . 'themes/global/image_max_dimensions.php');
			break;
		
		case 'photographer-wp':
