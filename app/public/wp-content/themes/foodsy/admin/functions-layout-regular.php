<?php
	...
	function foodsy_featured_media__layout_regular($first_full = 'No', $blog_grid_type = 'masonry')
	{
		$browser_address_url = stripcslashes(get_option(get_the_ID() . 'foodsy_featured_video_url'));
