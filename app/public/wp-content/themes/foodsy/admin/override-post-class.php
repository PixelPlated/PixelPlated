<?php
	...
	function foodsy_portfolio_page__post_class()
	{
	...
	function foodsy_category_link_style()
	{
		return get_theme_mod('foodsy_setting_meta_cat_link_style', 'is-cat-link-regular');
	}
	
	
	function foodsy_post_class($classes, $class, $post_id)
	{
		if (! is_admin())
		{
			...
			{
				$classes[] = esc_attr(foodsy_portfolio_page__post_class());
			}
			...
			{
				$classes[] = esc_attr(foodsy_category_link_style());
			}
		}
	...
	add_filter('post_class', 'foodsy_post_class', 10, 3);
