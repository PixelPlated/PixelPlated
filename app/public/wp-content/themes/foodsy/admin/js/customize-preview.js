...
// ====================================================================================================================
	...
	function foodsy_check_font_type(remove_class, css_selector_start, css_selector_end, font)
	{
		$('.' + remove_class).remove();
		...
		if (font.match('^FONT_LOCAL_'))
		{
			...
			var theme_directory_url = $('#foodsy_theme_directory_url').attr('content');
...
// ====================================================================================================================
	...
	// Font Family
 	...
 	wp.customize('foodsy_setting_font_text_logo', function(value)
	{
		value.bind(function(to)
		{
			foodsy_check_font_type('foodsy_setting_font_text_logo', '.site-title { font-family: ', '; }', to);
		});
	});
	
	
 	wp.customize('foodsy_setting_font_menu', function(value)
	{
		value.bind(function(to)
		{
			foodsy_check_font_type('foodsy_setting_font_menu', '.nav-menu, .entry-meta, .owl-nav, label, .page-links, .navigation, .entry-title i, .site-info, .filters { font-family: ', '; }', to);
		});
	});
	
	
 	wp.customize('foodsy_setting_font_widget_title', function(value)
	{
		value.bind(function(to)
		{
			foodsy_check_font_type('foodsy_setting_font_widget_title', '.widget-title { font-family: ', '; }', to);
		});
	});
	
	
 	wp.customize('foodsy_setting_font_h1', function(value)
	{
		value.bind(function(to)
		{
			foodsy_check_font_type(
				'foodsy_setting_font_h1',
 	...
 	wp.customize('foodsy_setting_font_h2_h6', function(value)
	{
		value.bind(function(to)
		{
			foodsy_check_font_type('foodsy_setting_font_h2_h6', 'h2, h3, h4, h5, h6, blockquote, .tab-titles { font-family: ', '; }', to);
		});
	});
	
	
 	wp.customize('foodsy_setting_font_slider_title', function(value)
	{
		value.bind(function(to)
		{
			foodsy_check_font_type('foodsy_setting_font_slider_title', '.slider-box .entry-title { font-family: ', '; }', to);
		});
	});
	
	
 	wp.customize('foodsy_setting_font_body', function(value)
	{
		value.bind(function(to)
		{
			foodsy_check_font_type('foodsy_setting_font_body', 'body { font-family: ', '; }', to);
		});
	});
	
	
 	wp.customize('foodsy_setting_intro_font', function(value)
	{
		value.bind(function(to)
		{
			foodsy_check_font_type('foodsy_setting_intro_font', '.intro h1 { font-family: ', '; }', to);
		});
	});
	
	
 	wp.customize('foodsy_setting_font_link_box_title', function(value)
	{
		value.bind(function(to)
		{
			foodsy_check_font_type('foodsy_setting_font_link_box_title', '.link-box .entry-title { font-family: ', '; }', to);
		});
	});
	
	
 	wp.customize('foodsy_setting_font_buttons', function(value)
	{
		value.bind(function(to)
		{
			foodsy_check_font_type('foodsy_setting_font_buttons', '.button, button, html .elementor-button, html .ekit-wid-con .elementskit-btn, html .ekit-wid-con .ekit_creative_button, .more-link { font-family: ', '; }', to);
		});
	});
	
	
 	wp.customize('foodsy_setting_font_tagline', function(value)
	{
		value.bind(function(to)
		{
			foodsy_check_font_type('foodsy_setting_font_tagline', '.site-description { font-family: ', '; }', to);
		});
	});
	
	
 	wp.customize('foodsy_setting_font_top_bar', function(value)
	{
		value.bind(function(to)
		{
			foodsy_check_font_type('foodsy_setting_font_top_bar', '.top-bar { font-family: ', '; }', to);
		});
	});
	
	
 	wp.customize('foodsy_setting_font_icon_box_title', function(value)
	{
		value.bind(function(to)
		{
			foodsy_check_font_type('foodsy_setting_font_icon_box_title', '.pw-icon-box h3 { font-family: ', '; }', to);
		});
	});
...
// ====================================================================================================================
 	...
 	wp.customize('foodsy_setting_content_width', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_page_post_content_width', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_menu_height', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_menu_sticky_height', function(value)
	{
		value.bind(function(to)
		{
			var styleCss = '<style type="text/css">' + 
...
// ====================================================================================================================
 	...
 	wp.customize('foodsy_setting_logo_height', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_logo_height_mobile', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_logo_height_sticky', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_logo_margin', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_logo_margin_mobile', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_logo_padding', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_logo_border_radius', function(value)
	{
		value.bind(function(to)
		{
...
// ====================================================================================================================
 	...
 	wp.customize('foodsy_setting_font_size_text_logo', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_font_size_text_logo_sticky', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_font_size_text_logo_mobile', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_font_size_tagline', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_font_size_blog_regular_post_title', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_font_size_blog_grid_post_title', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_font_size_h1', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_font_size_body', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_font_size_body_mobile', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_font_size_nav_menu', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_font_size_excerpt', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_font_size_blog_grid_excerpt', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_font_size_sidebar', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_font_size_sidebar_widget_title', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_font_size_nav_sub_menu', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_intro_font_size', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_font_size_meta', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_font_size_top_bar', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_font_size_buttons', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_font_size_copyright', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_font_size_icon_box_title', function(value)
	{
		value.bind(function(to)
		{
...
// ====================================================================================================================
 	...
 	wp.customize('foodsy_setting_header_top_bar_height', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_header_row_padding', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_header_vertical_width', function(value)
	{
		value.bind(function(to)
		{
			var styleCss = '<style type="text/css">' + 
...
// ====================================================================================================================
 	...
 	wp.customize('foodsy_setting_intro_text_transform', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_buttons__primary_button_border_radius', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_buttons__secondary_button_border_radius', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_header_sub_menu_animation_duration', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_sidebar_width', function(value)
	{
		value.bind(function(to)
		{
			var styleCss = '<style id="foodsy_setting_color_slider_meta_bg_border" type="text/css">' + 
...
// ====================================================================================================================
 	...
 	wp.customize('foodsy_setting_font_weight_text_logo', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_font_weight_h1', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_font_weight_h2_h6', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_font_weight_slider_title', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_font_weight_sidebar_widget_title', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_font_weight_nav_menu', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_font_weight_nav_sub_menu', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_intro_font_weight', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_font_weight_link_box_title', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_font_weight_buttons', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_font_weight_tagline', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_font_weight_top_bar', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_font_weight_copyright', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_font_weight_icon_box_title', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_font_weight_meta', function(value)
	{
		value.bind(function(to)
		{
...
// ====================================================================================================================
 	...
 	wp.customize('foodsy_setting_letter_spacing_main_slider_title', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_letter_spacing_nav_menu', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_letter_spacing_nav_sub_menu', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_letter_spacing_sidebar_widget_title', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_intro_letter_spacing', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_letter_spacing_link_box_title', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_letter_spacing_tagline', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_letter_spacing_buttons', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_letter_spacing_copyright', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_letter_spacing_icon_box_title', function(value)
	{
		value.bind(function(to)
		{
...
// ====================================================================================================================
 	...
 	wp.customize('foodsy_setting_text_transform_h1', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_text_transform_h2_h6', function(value)
	{
		value.bind(function(to)
		{
...
// ====================================================================================================================
 	...
 	wp.customize('foodsy_setting_body_line_height', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_header_bg_shape_height', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_featured_area_top_padding', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_featured_area_grid_spacing', function(value)
	{
		value.bind(function(to)
		{
			var styleCss = '<style type="text/css">' + 
 	...
 	wp.customize('foodsy_setting_header_border_top_width', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_header_menu_border_top_width', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_header_border_bottom_width', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_header_menu_border_bottom_width', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_header_border_left_width', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_header_menu_border_left_width', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_header_border_right_width', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_header_menu_border_right_width', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_header_border_top_radius', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_header_menu_border_top_radius', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_header_border_bottom_radius', function(value)
	{
		value.bind(function(to)
		{
 	...
 	wp.customize('foodsy_setting_header_menu_border_bottom_radius', function(value)
	{
		value.bind(function(to)
		{
...
// ====================================================================================================================
	...
	wp.customize('foodsy_setting_color_link', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_color_link_hover', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_color_header_bg', function(value)
	{
		value.bind(function(to)
		{
			var styleCss = '<style type="text/css">' +
	...
	wp.customize('foodsy_setting_color_header_background_gradient', function(value)
	{
		value.bind(function(to)
		{
			$('#foodsy_setting_color_header_background_gradient').remove();
			
			if (to != "")
			{
				var styleCss = '<style id="foodsy_setting_color_header_background_gradient" type="text/css">' + 
								
									'.site-header .header-wrap { background: linear-gradient(90deg, ' + api.instance('foodsy_setting_color_header_bg').get() + ' 30%, ' + to + ' 100%); }' +
			...
			else
			{
				var styleCss = '<style id="foodsy_setting_color_header_background_gradient" type="text/css">' +
									...
									'.site-header .header-wrap { background-color: ' + api.instance('foodsy_setting_color_header_bg').get() + '; }' +
									
									'html:not(.is-menu-bottom) .site-header .header-bg-shape { color: ' + api.instance('foodsy_setting_color_header_bg').get() + '; }' +
	...
	wp.customize('foodsy_setting_header_bg_img', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_color_menu_bg', function(value)
	{
		value.bind(function(to)
		{
			var styleCss = '<style type="text/css">' +
	...
	wp.customize('foodsy_setting_color_menu_background_gradient', function(value)
	{
		value.bind(function(to)
		{
			$('#foodsy_setting_color_menu_background_gradient').remove();
			
			if (to != "")
			{
				var styleCss = '<style id="foodsy_setting_color_menu_background_gradient" type="text/css">' + 
								
									'.site-header .menu-wrap { background: linear-gradient(90deg, ' + api.instance('foodsy_setting_color_menu_bg').get() + ' 30%, ' + to + ' 100%); }' + 
			...
			else
			{
				var styleCss = '<style id="foodsy_setting_color_menu_background_gradient" type="text/css">' + 
									...
									'.site-header .menu-wrap { background-color: ' + api.instance('foodsy_setting_color_menu_bg').get() + '; }' + 
									
									'html.is-menu-bottom .site-header .header-bg-shape { color: ' + api.instance('foodsy_setting_color_menu_bg').get() + '; }' + 
	...
	wp.customize('foodsy_setting_color_menu_active_link_text', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_color_menu_active_link_bg_border', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_color_menu_link_hover_text', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_color_menu_link_hover_bg_border', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_color_headings_text', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_color_body_text', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_color_body_bg', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_color_footer_bg', function(value)
	{
		value.bind(function(to)
		{
			if (to != "")
	...
	wp.customize('foodsy_setting_color_footer_background_gradient', function(value)
	{
		value.bind(function(to)
		{
			$('#foodsy_setting_color_footer_background_gradient').remove();
			
			if (to != "")
			{
				var styleCss = '<style id="foodsy_setting_color_footer_background_gradient" type="text/css">' + 
								
									'.site-footer { background: linear-gradient(130deg, ' + api.instance('foodsy_setting_color_footer_bg').get() + ' 30%, ' + to + ' 100%); }' + 
			...
			else
			{
				var styleCss = '<style id="foodsy_setting_color_footer_background_gradient" type="text/css">' + 
									...
									'.site-footer { background: ' + api.instance('foodsy_setting_color_footer_bg').get() + '; }' + 
	...
	wp.customize('foodsy_setting_color_footer_subscribe_bg', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_color_footer_subscribe_background_gradient', function(value)
	{
		value.bind(function(to)
		{
			$('#foodsy_setting_color_footer_subscribe_background_gradient').remove();
			
			if (to != "")
			{
				var styleCss = '<style id="foodsy_setting_color_footer_subscribe_background_gradient" type="text/css">' + 
								
									'.site .footer-subscribe { background: linear-gradient(130deg, ' + api.instance('foodsy_setting_color_footer_subscribe_bg').get() + ' 30%, ' + to + ' 100%); }' + 
			...
			else
			{
				var styleCss = '<style id="foodsy_setting_color_footer_subscribe_background_gradient" type="text/css">' + 
									...
									'.site .footer-subscribe { background: ' + api.instance('foodsy_setting_color_footer_subscribe_bg').get() + '; }' + 
	...
	wp.customize('foodsy_setting_color_copyright_bar_bg', function(value)
	{
		value.bind(function(to)
		{
			if (to != "")
	...
	wp.customize('foodsy_setting_color_copyright_bar_text', function(value)
	{
		value.bind(function(to)
		{
			if (to != "")
	...
	wp.customize('foodsy_setting_color_footer_text', function(value)
	{
		value.bind(function(to)
		{
			if (to != "")
	...
	wp.customize('foodsy_setting_color_cat_link_bg_border', function(value)
	{
		value.bind(function(to)
		{
			if (to != "")
	...
	wp.customize('foodsy_setting_color_slider_meta_bg_border', function(value)
	{
		value.bind(function(to)
		{
			$('#foodsy_setting_color_slider_meta_bg_border').remove();
	...
	wp.customize('foodsy_setting_color_widget_witle_bg_border', function(value)
	{
		value.bind(function(to)
		{
			$('#foodsy_setting_color_widget_witle_bg_border').remove();
			
			if (to != "")
			{
				var styleCss = '<style id="foodsy_setting_color_widget_witle_bg_border" type="text/css">' + 
	...
	wp.customize('foodsy_setting_color_primary_button', function(value)
	{
		value.bind(function(to)
		{
			$('#foodsy_setting_color_primary_button').remove();
			
			if (to != "")
			{
				var styleCss = '<style id="foodsy_setting_color_primary_button" type="text/css">' + 
	...
	wp.customize('foodsy_setting_color_primary_button_hover', function(value)
	{
		value.bind(function(to)
		{
			$('#foodsy_setting_color_primary_button_hover').remove();
			
			if (to != "")
			{
				var styleCss = '<style id="foodsy_setting_color_primary_button_hover" type="text/css">' + 
	...
	wp.customize('foodsy_setting_color_secondary_button', function(value)
	{
		value.bind(function(to)
		{
			$('#foodsy_setting_color_secondary_button').remove();
			
			if (to != "")
			{
				var styleCss = '<style id="foodsy_setting_color_secondary_button" type="text/css">' + 
	...
	wp.customize('foodsy_setting_color_secondary_button_hover', function(value)
	{
		value.bind(function(to)
		{
			$('#foodsy_setting_color_secondary_button_hover').remove();
			
			if (to != "")
			{
				var styleCss = '<style id="foodsy_setting_color_secondary_button_hover" type="text/css">' + 
	...
	wp.customize('foodsy_setting_intro_mask_color', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_color_top_bar_background', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_color_top_bar_background_gradient', function(value)
	{
		value.bind(function(to)
		{
			$('#foodsy_setting_color_top_bar_background_gradient').remove();
			
			if (to != "")
			{
				var styleCss = '<style id="foodsy_setting_color_top_bar_background_gradient" type="text/css">' + 
								
									'.top-bar { background: linear-gradient(90deg, ' + api.instance('foodsy_setting_color_top_bar_background').get() + ' 30%, ' + to + ' 100%); }' + 
			...
			else
			{
				var styleCss = '<style id="foodsy_setting_color_top_bar_background_gradient" type="text/css">' + 
									...
									'.top-bar, .top-bar select option { background-color: ' + api.instance('foodsy_setting_color_top_bar_background').get() + '; }' + 
	...
	wp.customize('foodsy_setting_color_header_text_custom', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_color_header_border', function(value)
	{
		value.bind(function(to)
		{
			$('#foodsy_setting_color_header_border').remove();
			
			if (to != "")
			{
				var styleCss = '<style id="foodsy_setting_color_header_border" type="text/css">' + 
			...
			else
			{
				var styleCss = '<style id="foodsy_setting_color_header_border" type="text/css">' + 
									...
									'.header-wrap:after { color: ' + api.instance('foodsy_setting_color_header_text_custom').get() + '; }' + 
	...
	wp.customize('foodsy_setting_color_header_border_gradient', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_color_menu_border', function(value)
	{
		value.bind(function(to)
		{
			if (to != "")
			...
			else
			{
				var styleCss = '<style type="text/css">' + 
									...
									'.is-menu-bar .menu-wrap:after { color: ' + api.instance('foodsy_setting_color_header_text_custom').get() + '; }' + 
	...
	wp.customize('foodsy_setting_color_menu_border_gradient', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_color_logo_text', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_color_logo_bg', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_color_logo_bg_gradient', function(value)
	{
		value.bind(function(to)
		{
			$('#foodsy_setting_color_logo_bg_gradient').remove();
			
			if (to != "")
			{
				var styleCss = '<style id="foodsy_setting_color_logo_bg_gradient" type="text/css">' + 
								
									'html .site-header .site-title a { background: linear-gradient(140deg, ' + api.instance('foodsy_setting_color_logo_bg').get() + ' 0%, ' + to + ' 90%); }' + 
			...
			else
			{
				var styleCss = '<style id="foodsy_setting_color_logo_bg_gradient" type="text/css">' + 
									...
									'html .site-header .site-title a { background: ' + api.instance('foodsy_setting_color_logo_bg').get() + '; }' + 
...
// ====================================================================================================================
 	...
 	wp.customize('foodsy_setting_custom_css', function(value)
	{
		value.bind(function(to)
		{
			$('#custom-css').remove();
...
// ====================================================================================================================
	...
	var foodsy_header_mask_style   = "horizontal";
	var foodsy_header_mask_color_1 = "";
	var foodsy_header_mask_color_2 = "";
	
	// DOCUMENT READY
	$(function() {
	
		foodsy_header_mask_style   = wp.customize('foodsy_setting_header_mask_style').get();
		foodsy_header_mask_color_1 = wp.customize('foodsy_setting_color_header_mask_1').get();
		foodsy_header_mask_color_2 = wp.customize('foodsy_setting_color_header_mask_2').get();
	});
	// DOCUMENT READY
	
	
	function foodsy_header_mask_style_css()
	{
		$('#header-mask-style').remove();
		
		var styleCss = "";
		
		if ((foodsy_header_mask_style == 'solid') && (foodsy_header_mask_color_1 !=""))
		{
			styleCss = '<style id="header-mask-style" type="text/css"> .header-wrap:before { background: ' + foodsy_header_mask_color_1 + '; } </style>';
		}
		else if ((foodsy_header_mask_style == 'radial') && (foodsy_header_mask_color_1 !="") && (foodsy_header_mask_color_2 !=""))
		{
			styleCss = '<style id="header-mask-style" type="text/css"> .header-wrap:before { background: radial-gradient(circle, ' + foodsy_header_mask_color_1 + ', ' + foodsy_header_mask_color_2 + '); } </style>';
		}
		else if ((foodsy_header_mask_style == 'vertical') && (foodsy_header_mask_color_1 !="") && (foodsy_header_mask_color_2 !=""))
		{
			styleCss = '<style id="header-mask-style" type="text/css"> .header-wrap:before { background: linear-gradient(' + foodsy_header_mask_color_1 + ', ' + foodsy_header_mask_color_2 + '); } </style>';
		}
		else if ((foodsy_header_mask_style == 'horizontal') && (foodsy_header_mask_color_1 !="") && (foodsy_header_mask_color_2 !=""))
		{
			styleCss = '<style id="header-mask-style" type="text/css"> .header-wrap:before { background: linear-gradient(130deg, ' + foodsy_header_mask_color_1 + ' 30%, ' + foodsy_header_mask_color_2 + ' 100%); } </style>';
		}
		else
		{
 	...
 	wp.customize('foodsy_setting_header_mask_style', function(value)
	{
		value.bind(function(to)
		{
			foodsy_header_mask_style = to;
			foodsy_header_mask_style_css();
		});
	});
	
	
	wp.customize('foodsy_setting_color_header_mask_1', function(value)
	{
		value.bind(function(to)
		{
			foodsy_header_mask_color_1 = to;
			foodsy_header_mask_style_css();
		});
	});
	
	
	wp.customize('foodsy_setting_color_header_mask_2', function(value)
	{
		value.bind(function(to)
		{
			foodsy_header_mask_color_2 = to;
			foodsy_header_mask_style_css();
		});
	});
...
// ====================================================================================================================
	...
	wp.customize('foodsy_setting_header_mask_opacity', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_header_half_transparent_bg_opacity', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_header_border_opacity', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_menu_border_opacity', function(value)
	{
		value.bind(function(to)
		{
...
// ====================================================================================================================
	...
	wp.customize('foodsy_setting_body_top_bottom_margin', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_intro_top_bottom_padding', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_intro_mask_opacity', function(value)
	{
		value.bind(function(to)
		{
...
// ====================================================================================================================
	...
	wp.customize('foodsy_setting_post_style', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_header_width', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_header_padding', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_header_text_color', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_menu_width', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_header_menu_align', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_header_menu_style', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_header_sub_menu_style', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_header_menu_text_transform', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_sidebar_widget_text_align', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_footer_subscribe_style', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_footer_widget_text_align', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_sidebar_widget_title_align', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_sidebar_widget_title_style', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_sidebar_trending_posts_style', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_main_slider_nav_position', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_main_slider_nav_shape', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_main_slider_nav_style', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_main_slider_title_text_transform', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_main_slider_title_style', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_author_info_box_style', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_share_links_style', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_tag_cloud_style', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_post_nav_image', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_post_nav_animated', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_comments_style', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_comment_image_shape', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_comment_form_style', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_body_layout', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_intro_text_align', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_intro_text_color', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_footer_layout', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_post_page_title_text_align', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_blog_text_align', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_meta_prefix_style', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_meta_cat_link_style', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_more_link_style', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_main_slider_meta_style', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_main_slider_more_link_visibility', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_main_slider_more_link_style', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_main_slider_text_align', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_main_slider_vertical_align', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_main_slider_horizontal_align', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_link_box_title_style', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_link_box_text_transform', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_link_box_text_align', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_link_box_vertical_align', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_header_sub_menu_align', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_related_posts_width', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_post_media_width', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_sidebar_position', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_post_title_style', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_author_info_box_align', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_share_links_align', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_main_slider_dots_style', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_text_transform_text_logo', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_text_transform_tagline', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_text_transform_meta', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_tagline_visibility', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_logo_container_width', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_logo_behaviour', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_logo_hover_effect', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_header_top_bar_mobile_visibility', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_header_top_bar_text_color', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_header_top_bar_text_transform', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_header_top_bar_style', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_header_top_bar_width', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_before_logo_area_visibility', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_after_logo_area_visibility', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_before_logo_area_items_align', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_after_logo_area_items_align', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_text_transform_buttons', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_header_sub_menu_animation', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_header_menu_link_hover_style', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_text_transform_copyright', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_make_sticky_header_menu_width_always_full', function(value)
	{
		value.bind(function(to)
		{
			if (to == true)
	...
	wp.customize('foodsy_setting_logo_bg_stretch_left', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_header_shadow', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_header_sticky_shadow', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_header_inner_style', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_header_transparent_style', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_header_bg_blur', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_menu_shadow', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_menu_sticky_shadow', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_menu_links_borders', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_menu_links_borders_style', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_footer_borders', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_footer_border_style', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_copyright_border_style', function(value)
	{
		value.bind(function(to)
		{
	...
	wp.customize('foodsy_setting_text_transform_icon_box_title', function(value)
	{
		value.bind(function(to)
		{
