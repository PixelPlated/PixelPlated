<?php
	...
	function foodsy_core_header_style()
	{
		$post_header_style   = "";
		...
		{
			$post_header_style = get_theme_mod('foodsy_setting_blog_homepage_header_style', ""); // Get blog homepage header style class. (customizer) --- BLOG HOMEPAGE
		}
		elseif (is_singular() || is_home()) // Blog page is a subpage.
		{
			if (function_exists('pixelwars_core_header_style'))
			{
				...
				if (($post_header_style == 'inherit') || empty($post_header_style))
				{
					...
					{
						$post_header_style = get_theme_mod('foodsy_setting_page_header_style_global', ""); // Get page header style class. (customizer) --- BLOG PAGE / PAGES
					}
					elseif (is_singular('post')) // Blog posts.
					{
						$post_header_style = get_theme_mod('foodsy_setting_post_header_style_global', ""); // Get post header style class. (customizer) --- BLOG POSTS
					}
					else // Portfolio posts AND other custom post types.
					{
						if (! is_attachment())
						{
							$post_header_style = get_theme_mod('foodsy_setting_custom_post_header_style_global', ""); // Get post header style class. (customizer) --- PORTFOLIO POSTS / CUSTOM POST TYPES
						}
					}
				}
			}
...
/* ============================================================================================================================================= */
	...
	function foodsy_core_post_style()
	{
...
/* ============================================================================================================================================= */
	...
	function foodsy_core_title_visibility()
	{
...
/* ============================================================================================================================================= */
	...
	function foodsy_core_featured_media__url()
	{
	...
	function foodsy_core_featured_media__new_tab()
	{
...
/* ============================================================================================================================================= */
	...
	function foodsy_core_iframe_from_xml($browser_address_url)
	{
	...
	function foodsy_iframe_from_xml($browser_address_url)
	{
		return foodsy_core_iframe_from_xml($browser_address_url);
	}
...
/* ============================================================================================================================================= */
	...
	function foodsy_core_gallery_type()
	{
...
/* ============================================================================================================================================= */
	...
	function foodsy_core_share_links_meta()
	{
	...
	function foodsy_core_share_links()
	{
		$share_links = get_theme_mod('foodsy_setting_share_links', 'Yes');
...
/* ============================================================================================================================================= */
	...
	function foodsy_core_related_posts()
	{
		if (is_singular('post'))
		{
			if (function_exists('pixelwars_core_related_posts'))
			{
				$related_posts = get_theme_mod('foodsy_setting_related_posts', 'Yes');
				
				if ($related_posts != 'No')
				{
					$related_posts_category = get_theme_mod('foodsy_setting_related_posts_category', 'all');
					$orderby                = get_theme_mod('foodsy_setting_related_posts_order', 'rand');
					$posts_per_page         = get_theme_mod('foodsy_setting_related_posts_count', '3');
					$related_posts_style    = get_theme_mod('foodsy_setting_related_posts_style', 'overlay');
...
/* ============================================================================================================================================= */
	...
	function foodsy_core_featured_area()
	{
		if (function_exists('pixelwars_core_featured_area'))
		{
			...
			{
				if ((! isset($_GET['featured_area'])) && is_home() && is_active_sidebar('foodsy_sidebar_13'))
				{
					?>
						<section class="top-content">
							<div class="layout-medium">
								<div class="featured-area">
									<?php
										dynamic_sidebar('foodsy_sidebar_13');
									?>
								</div> <!-- .featured-area -->
							</div> <!-- .layout-medium -->
						</section> <!-- .top-content -->
...
/* ============================================================================================================================================= */
	...
	function foodsy_core_sidebar($post_id)
	{
