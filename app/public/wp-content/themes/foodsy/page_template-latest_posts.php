										...
										if ($foodsy_query->have_posts()) :
											?>
												<h3 class="widget-title section-title">
													<span><?php esc_html_e('Latest From The Blog', 'foodsy'); ?></span>
																...
																<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
																	<div class="hentry-left">
																		...
																		<?php
																			if (has_post_thumbnail())
																			{
																				$feat_img = wp_get_attachment_image_src(get_post_thumbnail_id(), 'foodsy_image_size_5');
